<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="UgPart1_2020_25list.aspx.cs" Inherits="Admin_UgPart1_2020_25list" %>
					  ...
					  <table id="example5" class="text-fade table table-bordered example" style="width:100%">
						  <thead>
                                                ...
                                                <th style="text-align:center;">#</th>   
													 ...
													 <th style="text-align:center;">PPU Confidential No</th>
                                                    ...
                                                    <th style="text-align:center;">Reg_No</th>
													 ...
													 <th style="text-align:center;">Subsidery1</th>
													 <th style="text-align:center;">Subsidery2</th>
							...
							<td><%# Eval("Reg_No") %></td>
													...
													<td><%# Eval("Subsidery1") %></td>
													<td><%# Eval("subsidery2") %></td>
														<td><%# Eval("Composition") %></td>
													    <td>
