...
public partial class Admin_12thexamdata : System.Web.UI.Page
{
    ...
    protected void getdata()
    {
        try
        {
            SqlDataAdapter ord = new SqlDataAdapter("select  * from tblinterexam_2021_23 where  status='Active' and payment='paid' order by id desc", con);
