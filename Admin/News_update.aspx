<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="News_update.aspx.cs" Inherits="Admin_Notice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Notice News</h4>
								...
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
                                                     <label for="txtnotice_title" class="control-label">News Title :</label>
								  ...
								  <div class="col-md-6">
									<div class="form-group">
                                              <label for="aadhar" class="control-label">News Date</label>
                                                <%--<input type="text" class="form-control input-default" placeholder="Input Default">--%>
...
<div class="col-md-12">
									<div class="form-group">
                                  <label for="mobile" class="control-label">News Details</label>
                                                <%--<input type="text" class="form-control input-default" placeholder="Input Default">--%>
