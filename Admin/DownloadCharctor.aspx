<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="DownloadCharctor.aspx.cs" Inherits="Admin_DownloadCharctor" %>
...
@media print {
  ...
  <p><asp:Label ID="lblmother" Text="Mother's Name" class="all few m-l-15 m-r-15" runat="server"></asp:Label></p>
              ...
              is a student of
              <span class="dash m-l-15 m-r-15"><asp:Label ID="txtsubject" Text="Vocational BCA (UG)" class="all few  m-l-15 m-r-15" runat="server"></asp:Label></span>
              Part- 
               <span class="dash m-l-15 m-r-15"><asp:Label ID="yrs"  Text="3" class="all few  m-l-15 m-r-15" runat="server"></asp:Label></span>
              During Session
                  ...
                  <span class="dash m-l-15 m-r-15"><asp:Label ID="txtsession"  Text="2020-2023" class="all few  m-l-15 m-r-15" runat="server"></asp:Label></span>
               His/Her Class Roll no. is
               <span class="dash m-l-15 m-r-15"><asp:Label ID="sname1" Text="001" class="all few" runat="server"></asp:Label></span>
                  and result is <span class="dash m-l-15 m-r-15"><asp:Label ID="Label1"  Text="1st"  class="all few" runat="server"></asp:Label></span>
