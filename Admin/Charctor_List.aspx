<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Charctor_List.aspx.cs" Inherits="Admin_Charctor_List" %>
	...
	<!-- Content Header (Page header) -->
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">View All Charchtor Data</h4>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="ti-home"></i></a></li>
								<li class="breadcrumb-item" aria-current="page">Admin Management</li>
								<li class="breadcrumb-item active" aria-current="page">Charchtor</li>
							</ol>
						</nav>
					</div>
				</div>
			 ...
			 <div class="row" id="stu_div" runat="server">			  
				<div class="col-lg-12 col-12">
					  <div class="box">
						<div class="form">
							<div class="box-body">
								<h4 class="box-title text-primary mb-0"><i class="ti-user me-15"></i>Apply Charchtor Details</h4>
								<hr class="my-15">
						  ...
						  <thead>
                                             ...
                                             <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand"><ItemTemplate>
                                                <tr class="text-dark"> 
                                                    ...
                                                    <td> <a  href='<%#Eval("Student_id","Charctor_fromUpdate.aspx?id={0}") %>'  class="btn btn-primary" ><%#Eval("Student_id")%></a></td>
							                        <td><%# Eval("Reg_no") %></td>
													<td><%# Eval("Roll_no") %></td>
                            ...
                            <asp:LinkButton ID="delete"  CommandArgument='<%# Eval("ID") %>' CommandName="Delete"  runat="server" OnClienCharchtorlick="if ( !confirm('Are you sure you want to delete this record?')) return false;"><i class="ti-trash color-danger"></i></asp:LinkButton>
                                                    </td>
                                                </tr>  
                                                </ItemTemplate>
                                                </asp:Repeater>                                          
