<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="complaints.aspx.cs" Inherits="Admin_complaints" %>
				...
				<div class="col-lg-12 col-12">
					  ...
					  <table id=""  class="text-fade table table-bordered example" style="width:100%">
					    ...
					    <tbody>
                            ...
                            <asp:LinkButton ID="delete"  CommandArgument='<%# Eval("id") %>' CommandName="Delete"  runat="server" ><%# Eval("Status") %></asp:LinkButton>
                                                    </td>
                                                </tr>  
                                                </ItemTemplate>
                                                </asp:Repeater>                                          
