...
public partial class Admin_UGVocational_2022_25list : System.Web.UI.Page
{
    ...
    protected void getdata()
    {
        try
        {
            SqlDataAdapter ord = new SqlDataAdapter("select  * from tblvocationalAddmissionpart1_2022_25 where  status='Active' and payment='paid' order by id desc", con);
