...
public partial class Admin_Intermediatelist_2022_24 : System.Web.UI.Page
{
    ...
    protected void getdata()
    {
        try
        {
            SqlDataAdapter ord = new SqlDataAdapter("select  * from tblinterAddmission_2022_24 where  status='Active' and payment='paid' order by id desc", con);
