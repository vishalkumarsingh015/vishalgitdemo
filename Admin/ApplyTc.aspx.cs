...
public partial class Admin_ApplyTc : System.Web.UI.Page
{
    string img1, img2;
    ...
    protected void save_Click(object sender, EventArgs e)
    {
        ...
        int i = 0;
        i = sql.ExecuteSql("insert into Apply_tc (Reg_no,Roll_no,Student_name,Father_name,mother_name,Mobile,Aadhar,email,gender,Session_from,Session_to,Stream,Honours,Fee_recipt,Marksheet,addeddate,addedby,Passing_year,division,address,status,Activity) values ('" + txtregno.Text + "','" + txtrollno.Text + "','" + txtstudent_num.Text + "','" + txtfathername.Text + "','" + txtmother.Text + "','" + mobile.Text + "','" + txtaadhar_no.Text + "','" + email.Text + "','" + ddlgender.SelectedValue + "','" + txtsessionfrom.Text + "','" + txtsessionto.Text + "','" + txtstream.Text + "','" + txtsub.Text + "','" + img1 + "','" + img2 + "','" + System.DateTime.UtcNow.AddMinutes(330).ToString() + "','Admin','" + txtPas_year.Text + "','" + txtdivision.Text + "','" + txtaddress.Text + "','Active','Pending')");
    ...
    protected void getlogin()
    {
        try
        {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    txtstudent_num.Text = dt.Rows[0]["name"].ToString();
    ...
    public void payment(string id)
    {
        ...
        string ru = "http://www.anscollege.ac.in/PG3rdrecipet.aspx";
