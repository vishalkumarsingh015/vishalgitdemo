...
public partial class Admin_12thadmission2020 : System.Web.UI.Page
{
    ...
    protected void getdata()
    {
        try
        {
            SqlDataAdapter ord = new SqlDataAdapter("select  * from tblinterAddmission_2022 where  status='Active' and payment='paid' order by id desc", con);
