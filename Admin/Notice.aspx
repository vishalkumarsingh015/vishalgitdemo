		...
		<section class="content">
			...
			<asp:Label ID="lblid" runat="server" Visible="false" Text="Label"></asp:Label>
								...
								<div class="row">
								  ...
								  <div class="col-md-6">
									<div class="form-group">
                                                     <label for="txtnotice_title" class="control-label">Notice Title :</label>
								  ...
								  <div class="col-md-6">
									<div class="form-group">
                                              <label for="aadhar" class="control-label">Notice Date</label>
                                                <%--<input type="text" class="form-control input-default" placeholder="Input Default">--%>
                <asp:TextBox ID="txtnotice_date" runat="server" class="form-control datepicker"   placeholder="DD-MM-YYYY" AutoComplete="off" onkeydown="javascript:return false"></asp:TextBox>
                                    ...
                                    <div class="col-md-6">
									<div class="form-group">
                                  <label for="mobile" class="control-label">Notice Details</label>
                                                <%--<input type="text" class="form-control input-default" placeholder="Input Default">--%>
                  ...
                  <asp:FileUpload ID="FileUpload1"  runat="server" class=" form-control input-default"/>
              <%--    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ForeColor="Red" ControlToValidate="FileUpload11"
				...
				<div class="col-lg-12 col-12">
					  <div class="box">
						<div class="form">
							<div class="box-body">
								<h4 class="box-title text-primary mb-0"><i class="ti-user me-15"></i>Notice Details</h4>
								<hr class="my-15">
					  ...
					  <table id="example" class="text-fade table table-bordered example" style="width:100%">
					   	<thead>
							<tr class="text-dark">
                                                ...
                                                <th style="text-align:center;">Notice Details</th>
