...
public partial class Admin_UgPart1_2020_25list : System.Web.UI.Page
{
    ...
    protected void getdata()
    {
        try
        {
            SqlDataAdapter ord = new SqlDataAdapter("select  * from tblugPart1Addmission_2020_25 where  status='Active' and payment='paid' order by id desc", con);
