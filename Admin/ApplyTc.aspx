<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ApplyTc.aspx.cs" Inherits="Admin_ApplyTc" %>
...
<!-- Content Header (Page header) -->
    ...
    <div class="row">			  
      ...
      <asp:FileUpload ID="FileUpload1"  runat="server" class=" form-control input-default" onchange="ShowImagePreview1(this);"/>
   ...
   <asp:FileUpload ID="FileUpload2"  runat="server" class=" form-control input-default" onchange="ShowImagePreview2(this);"/>
