...
public partial class Admin_intermediate_Registrationdata : System.Web.UI.Page
{
    ...
    protected void getdata()
    {
        try
        {
            SqlDataAdapter ord = new SqlDataAdapter("select  * from tblinterregistration_2022_24 where    payment='paid' order by id desc", con);
