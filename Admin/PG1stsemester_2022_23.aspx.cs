...
public partial class Admin_PG1stsemester_2022_23 : System.Web.UI.Page
{
    ...
    protected void getdata()
    {
        try
        {
            SqlDataAdapter ord = new SqlDataAdapter("select  * from tblpgADMISSION_1st_2022_24 where  status='Active' and payment='paid' order by id desc", con);
