...
public partial class Student_Bonafide_recipet_fee : System.Web.UI.Page
{
    string id;
                    ...
                    else if (Request.Params["f_code"].ToString() == "Ok")
                    {
                        ...
                        if (Request.Params["mmp_txn"] != null)
                        {
                            ...
                            if (signature == ressignature)
                            {
                                ...
                                con.Open();
                                SqlCommand cmd1 = new SqlCommand("update Apply_Bonafide set payment_status='paid' ,fee='" + postinamount + "',trans_id='" + resgistration + "' where Reg_No='" + resgistration + "'", con);
    ...
    protected void getdata(string a)
    {
        try
        {
            DataTable dt = sql.GetDataTable(@"select * from Apply_Bonafide_fee as ta where ta.Reg_No='" + a + "'  ");
