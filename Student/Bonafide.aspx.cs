...
public partial class Student_Bonafide : System.Web.UI.Page
{
    string img1, img2;
    ...
    protected void save_Click(object sender, EventArgs e)
    {
        ...
        int i = 0;
        i = sql.ExecuteSql(@"insert into Apply_Bonafide ( [Reg_no], [Roll_no], [Student_name], [Father_name], [mother_name], [Mobile], [Aadhar], [email], [gender], [Session_from], [Session_to],
    ...
    public void payment(string id)
    {
        ...
        string ru = "https://www.anscollege.ac.in/Student/Bonafide_recipet.aspx";
