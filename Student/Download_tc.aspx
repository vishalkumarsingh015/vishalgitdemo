<%@ Page Title="" Language="C#" MasterPageFile="~/Student/MasterPage.master" AutoEventWireup="true" CodeFile="Download_tc.aspx.cs" Inherits="Student_Download_tc" %>
...
@media print {
  ...
  <p>Reg.No:<asp:Label ID="txtreg_no" class="all few m-l-15 m-r-15" Text="20Gugf0808090" runat="server"></asp:Label></p>
                  ...
                  <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="margin-bottom:-67px">
                    <div class="row">
                         <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" align="right">
                             <asp:Image ID="Image1" class="img img-responsive" style="width:80px;" ImageUrl="../img/default.png" runat="server" ></asp:Image>
