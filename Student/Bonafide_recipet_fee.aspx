<%@ Page Title="" Language="C#" MasterPageFile="~/Student/MasterPage.master" AutoEventWireup="true" CodeFile="Bonafide_recipet_fee.aspx.cs" Inherits="Student_Bonafide_recipet_fee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">  Bonafide/College Fee structure Receipt</h4>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="ti-home"></i></a></li>
								<li class="breadcrumb-item" aria-current="page">  Bonafide/College Fee structure Receipt</li>
								<li class="breadcrumb-item active" aria-current="page">  Bonafide/College Fee structure Receipt</li>
							</ol>
						</nav>
					</div>
				</div>
     ...
     <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="border: 1px solid black;margin-bottom:20px;">  
      ...
      <div class="col-lg-10 col-md-10 col-xs-10 col-sm-10 abc" align="center">
              ...
              <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 abc" align="center">
               <h4 style="margin-bottom:0;font-family:Cursive;">  Bonafide/College Fee structure   Receipt</h4>
