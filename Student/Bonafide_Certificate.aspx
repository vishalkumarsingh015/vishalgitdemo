<%@ Page Title="" Language="C#" MasterPageFile="~/Student/MasterPage.master" AutoEventWireup="true" CodeFile="Bonafide_Certificate.aspx.cs" Inherits="Student_Bonafide_Certificate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title"> Bonafide Certificate</h4>
					<div class="d-inline-block align-items-center">
						<nav>
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#"><i class="ti-home"></i></a></li>
								<li class="breadcrumb-item" aria-current="page">Generate Certificate</li>
								<li class="breadcrumb-item active" aria-current="page">Bonafide Certificate</li>
							</ol>
						</nav>
					</div>
				</div>
          ...
          <div class="row"> 
            ...
            <div class="col-lg-10 col-md-10 col-xs-10 col-sm-10 abc" align="center">
              ...
              <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 abc" align="center">
               <h4 style="margin-bottom:0;font-family:Cursive;">Bonafide Certificate</h4>
              ...
              <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12"> 
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding: 30px 50px; line-height:2.5;">
              ...
              is a regular Student of Class
              <span class="dash m-l-15 m-r-15"><asp:Label ID="txtclass" Text="I.Sc"  class="all few  m-l-15 m-r-15" runat="server"></asp:Label>(<asp:Label ID="Label10" Text="Science"  class="all few" runat="server"></asp:Label>)</span>
               Class Roll No  
